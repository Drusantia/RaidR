...
import net.drusantia.raidr.data.model.character.ItemQuality
...
val NetworkKoinModule = module {
    ...
    single { provideRaiderIoGeneralApi(get()) }
    ...
    single { RaiderIoGeneralRepository(get(), get()) }
...
private fun provideRaiderIoGeneralApi(retrofit: Retrofit): RaiderIoGeneralApi = retrofit.create(RaiderIoGeneralApi::class.java)
